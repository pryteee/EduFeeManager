...
class UpdateStudent:
    ...
    def build_ui(self):
        ...
        tk.Label(outer, text="Fill in student details and course total_fee",
        ...
        fields = [
            ...
            ("Course fee",    self.total_fee_var,     False),
            ("usernamename",      self.username_var,    False),
    ...
    def add(self):
        ...
        try:
            ...
            total_fee  = float(self.total_fee_var.get().strip())
        except ValueError:
            messagebox.showerror("Error", "academic_year must be integer, total_fee must be number!", parent=self.root)
            return
        ...
        if success:
            self.f_model.create_fee_record(s_id, total_fee)
