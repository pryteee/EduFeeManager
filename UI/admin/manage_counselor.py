...
#             ("✏️  Edit Counselor",       BTN_BLUE, self.edit_counselor,   0, 1),
#             ("🗑️  Delete Counselor",    BTN_BLUE, self.delete_counselor,  1, 0),
#             ("👁️  View Counselor",      BTN_BLUE, self.view_counselor,    1, 1),
#             ("📋  View All Counselors",  BTN_BLUE, self.view_all,          2, 0),
#             ("🗑️  Delete Student",      ACCENT,   self.delete_student,    2, 1),
#         ]
